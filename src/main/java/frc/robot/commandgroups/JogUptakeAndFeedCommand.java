...
public class JogUptakeAndFeedCommand extends SequentialCommandGroup {


  /** Creates a new JogUptakeAndFeedCommand. */
  public JogUptakeAndFeedCommand(HopperFeed hopper, Uptake uptake) {
