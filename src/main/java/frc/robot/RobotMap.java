...
public class RobotMap {
    ...
    public static class CANID {
        ...
        // Intake motors
        public static final int INTAKE_SPIN_R = 28;
         public static final int INTAKE_SPIN_L= 29;
    ...
    public static class Turret {
        ...
        public static final double MAX_ROTATION_DEGREES = 90.0;// was 90.0;
        public static final double MIN_ROTATION_DEGREES = -90.0; // was -90.0;
